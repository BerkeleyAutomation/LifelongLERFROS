...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument('input_cloud_topic', default_value='/camera/pointcloud'),
        ...
        DeclareLaunchArgument('ground_filter/distance', default_value='0.0'),
        DeclareLaunchArgument('ground_filter/angle', default_value='0.15'),
        DeclareLaunchArgument('ground_filter/plane_distance', default_value='0.0'),
        ...
        DeclareLaunchArgument('sensor_model/hit', default_value='0.51'),
        DeclareLaunchArgument('sensor_model/miss', default_value='0.49'),
        DeclareLaunchArgument('sensor_model/min', default_value='0.1'),
        DeclareLaunchArgument('sensor_model/max', default_value='0.9'),
        ...
        DeclareLaunchArgument('color_free/r', default_value='1.0'),
