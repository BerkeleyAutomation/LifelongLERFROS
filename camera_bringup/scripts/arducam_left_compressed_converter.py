...
class ImageRepublisherNode(Node):
    def __init__(self):
        ...
        self.color_sub = self.create_subscription(CompressedImage, '/camLeft/image_raw/compressed_synced', self.color_callback, 1)
    ...
    def color_callback(self, msg):
        end_time = time.time()
        #print("Time taken: " + str(end_time - self.start_time) + " seconds.",flush=True)
        try:
