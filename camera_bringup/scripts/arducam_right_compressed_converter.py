...
class ImageRepublisherNode(Node):
    def __init__(self):
        ...
        self.color_sub = self.create_subscription(CompressedImage, '/camRight/image_raw/compressed_synced', self.color_callback, 1)
        self.color_pub = self.create_publisher(Image, '/repub/camRight/image_raw', 1)
